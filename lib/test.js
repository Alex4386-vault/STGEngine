...
function charMoveRoutine() {
    var moveX = key_1.key.keyLeft && key_1.key.keyRight ? 0 :
        key_1.key.keyRight ? config_1.config.playerVelocity :
            key_1.key.keyLeft ? -config_1.config.playerVelocity :
                0;
    var moveY = key_1.key.keyUp && key_1.key.keyDown ? 0 :
        key_1.key.keyUp ? -config_1.config.playerVelocity :
